...
# --- Page Setup ---
st.set_page_config(page_title="Dyce Contract Decision Engine V25", layout="wide")
...
st.markdown("""
    <style>
        ...
        label, .stMarkdown, .css-1cpxqw2, div[data-baseweb="select"] {
...
st.title(f"⚡ Dyce Contract Decision Engine V25 ({VERSION})")
...
number_of_sites = st.number_input("Number of Sites", 1, 500)
